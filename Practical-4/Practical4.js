...
function fetchData(){
    fetch('https://employee-registration-f79aa-default-rtdb.firebaseio.com/employees.json')
        .then(res => {
            if(res.ok){
                return res.json();
            }
...
async function submitForm(event){
    ...
    const response = await fetch('https://employee-registration-f79aa-default-rtdb.firebaseio.com/employees.json', {
        method: 'POST',
        headers: {
...
function renderDataInTheTable(empData) {
    ...
    empData.forEach(emp => {
        ...
        btn.onclick = function(){
            console.log(emp.id);
            fetch(`https://employee-registration-f79aa-default-rtdb.firebaseio.com/employees/${emp.id}.json`,{
                method: 'Delete',
                headers: {
                  'Content-Type': 'application/json'
                },
